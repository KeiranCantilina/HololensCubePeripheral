...
public class IMU_DataPacket
{
...

    {
        ...
        IMU_Data.rX = (float) BitConverter.ToSingle(data, 0);
        IMU_Data.rY = (float) BitConverter.ToSingle(data, 4);
        IMU_Data.rZ = (float) BitConverter.ToSingle(data, 8);
        IMU_Data.rW = (float) BitConverter.ToSingle(data, 12);
    ...
    public override string ToString()
    {
        ...
        // Previous method was slooooow so this is a replacement
        qX = rX.ToString("0.00000");
        qY = rY.ToString("0.00000");
        qZ = rZ.ToString("0.00000");
        qW = rW.ToString("0.00000");
